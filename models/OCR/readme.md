...
PaddleOCR，克隆PaddleOCR的仓库，并进行安装，由于PaddleOCR仓库比较大，git clone速度比较慢，所以本教程已下载

```
git clone https://github.com/PaddlePaddle/PaddleOCR.git -b release/2.4
...
<div align="center">
    <img src="./images/lite_demo_onnx.png" width=300">
</div>

Paddle Inference 执行效果：

<div align="center">
    <img src="./images/lite_demo_paddle.png" width=300">
</div>
