...
def multiclass_nms(bboxes,
    ...
    if in_dygraph_mode():
        ...
        #  score_thresh=0.01, nms_thresh=0.45, pre_nms_topk=1000, pos_nms_topk=100
        # t2 = multiclass_nms1(bboxes, scores, score_threshold, nms_threshold, nms_top_k, keep_top_k)

        # t = paddle.fluid.layers.multiclass_nms(bboxes, scores, score_threshold, nms_top_k, keep_top_k, nms_threshold=nms_threshold,
        #                                    normalized=normalized, nms_eta=nms_eta, background_label=background_label)
...
def test_divide_9():
    ...
    obj = APIOnnx(op, 'multiclass_nms3', [12])
    import numpy as np
