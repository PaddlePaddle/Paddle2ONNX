...
class PicodetRKNN:
    def __init__(self,
        ...
        # Create RKNN object
        rknn_config = RKNNConfigBoard(rknn_path=model_path)
    ...
    def infer(self, img):
        ...
        for i in range(len(result) // 4 + 1):
            ...
            result_out.append(np.transpose(result[i][0], (2, 0, 1)))
        result = result_out
    ...
    def predict(self, img):
        ...
        cv2.imwrite('../images/after/rknn_board_result.jpg', res_image)
...
if __name__ == '__main__':
    ...
    picodet_infer_onnx = PicodetRKNN(model_path=model_path)
