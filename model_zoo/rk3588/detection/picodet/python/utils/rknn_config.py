class RKNNConfigPC:
    ...
    def create_rknn(self):
        ...
        ret = rknn.load_onnx(model=self.model_path,
                             outputs=['conv2d_140.tmp_0', 'conv2d_137.tmp_0', 'transpose_1.tmp_0',
                                      'conv2d_148.tmp_0', 'conv2d_145.tmp_0', 'transpose_3.tmp_0',
                                      'conv2d_156.tmp_0', 'conv2d_153.tmp_0', 'transpose_5.tmp_0',
                                      'conv2d_164.tmp_0', 'conv2d_161.tmp_0', 'transpose_7.tmp_0', ])
        if ret != 0:
...
class RKNNConfigBoard:
    ...
    def create_rknn(self):
        ...
        rknn.list_support_target_platform(rknn_model=self.model_path)
