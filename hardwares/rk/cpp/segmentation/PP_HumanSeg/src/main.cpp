...
char img_path[] = "./images/before/PP_HumanSeg_demo_input.jpg";
char model_path[] = "./model/portrait_pp_humansegv2_lite_256x144_inference_model_with_softmax.rknn";
...
int main() {
    ...
    printf("-> HumanSeg\n");
    PP_HumanSeg ppHumanSeg = PP_HumanSeg();
    ppHumanSeg.predict(results,src_img,save_path);
    return 0;
}