...
def parse_args():
    ...
    parser.add_argument('--resize_size', default=[320, 320], help='resize_size')
...
def main():
    ...
    if args.backend_type == "rk_hardware":
        ...
        rk_hardware_runner = DetectionInfer()
    ...
    if args.backend_type == "onnxruntime":
        ...
        onnxruntime_runner = DetectionInfer()
        onnxruntime_runner.set_runner(args)
        onnxruntime_runner.predict()

    if args.backend_type == "paddle":
        print(">>> Paddle Infer")
        paddle_runner = DetectionInfer()
