...
- Supported ops. Paddle2ONNX can stably export models to ONNX Opset 9~11, and partialy support lower version Opset. More details please refer to [op list](docs/op_list.md).
