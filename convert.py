...
def parse_args():
    ...
    parser.add_argument("--onnx_model", required=False,
...
def convert(args):
    ...
    with fluid.scope_guard(inference_scope):
        ...
        graph = helper.make_graph(onnx_nodes, model_name, inputs, outputs)

        # make model
        model = helper.make_model(graph, producer_name='PaddlePaddle')
