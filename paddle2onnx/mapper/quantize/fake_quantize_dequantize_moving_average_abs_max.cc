...
#include "paddle2onnx/mapper/quantize/fake_quantize_dequantize_moving_average_abs_max.h"

namespace paddle2onnx {
REGISTER_MAPPER(fake_quantize_dequantize_moving_average_abs_max,
                FakeQuantizeDequantizeMovingAverageAbsMaxMapper)

int32_t FakeQuantizeDequantizeMovingAverageAbsMaxMapper::GetMinOpset(
    bool verbose) {
...
void FakeQuantizeDequantizeMovingAverageAbsMaxMapper::Opset10() {
