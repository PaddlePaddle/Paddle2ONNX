...
- A [design document of the underlying ideas](https://github.com/PaddlePaddle/FluidDoc/blob/release/1.4/doc/fluid/design/onnx/onnx_convertor.md) behind how this program converts the model from PaddlePaddle to ONNX.
- Understand [PaddlePaddle's (non-)graph way of representing a deep learning program](https://github.com/PaddlePaddle/FluidDoc/blob/release/1.4/doc/fluid/design/concepts/program.md), a `ProgramDesc`.
